...
public class Grid {
    ...
    public static Point[][] startingGrid(int lineSize,int gridHight,int gridWidth) {
        ...
        int x = (int) gridHight/2;
        int y = (int) gridWidth/2;
        int a = lineSize-1;

        if (a == 4) {

            gameGrid[x - a][y-1].setState(0);
            gameGrid[x - a][y].setState(0);
            gameGrid[x - a][y + 1].setState(0);
            gameGrid[x - a][y + 2].setState(0);
