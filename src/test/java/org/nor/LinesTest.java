...
public class LinesTest {
	...
	public void equalsLinesTest() {
		assertTrue(new Lines(new Point(0,0),new Point(1,1)).equals(new Lines(new Point(0,0),new Point(1,1))));
		assertFalse(new Lines(new Point(0,0),new Point(1,1)).equals(new Lines(new Point(0,2),new Point(1,1))));
	}
